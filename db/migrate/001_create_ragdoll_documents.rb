...
class CreateRagdollDocuments < ActiveRecord::Migration[7.0]
  def change
    create_table :ragdoll_documents,
                 comment: 'Core documents table storing document content, metadata, AI-generated summaries and keywords for RAG search' do |t|
      ...
      t.text :summary,
             comment: 'AI-generated summary using LLM providers, primary field for full-text search'
      ...
      t.text :keywords,
             comment: 'AI-extracted comma-separated keywords for faceted search and categorization'
      ...
      t.string :document_type, null: false, default: 'text',
                               comment: 'Document format type determining parsing strategy (pdf, docx, text, markdown, html)'
      ...
      t.json :metadata, default: {},
                        comment: 'Flexible JSON storage for document metadata, file properties, and custom attributes'
